...
from qdrant_app.schemas.qdrant import QdrantAddReportResponse, QdrantReportData
...
async def qdrant_set_data(data: QdrantReportData, qd_manager: QdrantReportsStorage = Depends(get_qdrant_report_service)) -> QdrantAddReportResponse:
