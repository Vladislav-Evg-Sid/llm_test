...
Нужно выполнить задачу максимально внимательно, строго и профессионально. Особенно важно не допускать домыслов, не подменять анализ общими фразами и не терять значимые различия между 2026, 2025 и 2024 годами.
...
- корректно сопоставлять 2026 год с 2025 и 2024 годами;
...
Важно сделать выводы содержательными, конкретными и аналитичными: отметить значимые тенденции, сопоставить 2026 год с 2025 и 2024 годами и сохранить официальный стиль отчёта без лишней риторики.
...
Временной контекст:
- текущий анализ относится к 2026 году;
- при формулировании выводов сравнивай показатели 2026 года с данными за 2025 и 2024 годы.
