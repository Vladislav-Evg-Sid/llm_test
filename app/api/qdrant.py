...
async def qdrant_set_data(data: QdrantReportData, qd_manager: QdrantReportsService = Depends(get_qdrant_report_service)) -> QdrantAddReportResponse:
...
@router.delete("/reports/{report_id}", response_model=QdrantDeleteReportResponse)
