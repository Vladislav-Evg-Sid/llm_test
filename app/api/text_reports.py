...
async def generate_sections(section_code: str = "1.7.", session: AsyncSession = Depends(get_async_session)) -> LLMResponse:
    return await llmService.get_generated_text_on_subject_by_section(session, section_code)
